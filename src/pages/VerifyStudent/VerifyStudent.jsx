...
const VerifyStudent = () => {
  ...
  const handleSearch = async (e) => {
    ...
    console.log(search)
    try {
      const res = await axios.post("http://localhost:5000/student/fetch-pending-regex", { findStr: search })
      if (res) {
  ...
  const handleEnrollment = async () => {
    ...
    try {
      const res = await axios.post(
        'http://localhost:5000/student/fetch-pending-enrollment',
            ...
            <tbody>
              {students.map((student) => (
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="px-6 py-4">
                    <div className="max-w-sm mx-auto">
                      <select
                        ...
                        onChange={(e) => handleStatusChange(e.target.value,student._id)}
                      >
                  ...
                  <td class="px-6 py-4">
                    <Link className="hover:text-blue-500" to={`/check-student/${student.isVerified}/${student._id}`}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
