          ...
          <div className="w-full max-w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <section className="p-6 dark:bg-gray-100 dark:text-gray-800">
              <div className="container mx-auto">
                ...
                <div className="grid gap-6 mb-16 mt-8 sm:grid-cols-2 lg:grid-cols-3">
                  {companies.map((company, idx) => (
                    ...
                    >
                      ...
                      >
                        {/* Success */}
                        {company.applyStudents.includes(studentProfile.data._id) && <span className="inline-flex items-center justify-center rounded-full bg-emerald-100 px-2.5 py-0.5 text-emerald-700">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                        ...
                        {/* Warning */}
                        {company.eligibleStudents.includes(studentProfile.data._id) && !company.applyStudents.includes(studentProfile.data._id) && (
                        ...
                        {/* Error */}
                       { !company.eligibleStudents.includes(studentProfile.data._id) && <span className="inline-flex items-center justify-center rounded-full bg-red-100 px-2.5 py-0.5 text-red-700">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
